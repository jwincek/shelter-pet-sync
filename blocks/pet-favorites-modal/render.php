...
<div <?php echo $wrapper_attributes; /* phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- get_block_wrapper_attributes() returns escaped HTML. */ ?>>
	...
	<button
		...
		aria-label="<?php esc_attr_e( 'View favorites', 'shelterkit-pets' ); ?>"
	>
		<svg
	...
	<div
		...
		role="dialog"
		aria-modal="true"
		aria-label="<?php esc_attr_e( 'Your favorite pets', 'shelterkit-pets' ); ?>"
		hidden
	>
		<div class="pet-favorites-modal__panel">
			...
			<div class="pet-favorites-modal__header">
				<h2 class="pet-favorites-modal__title">
					...
					<?php esc_html_e( 'Favorites', 'shelterkit-pets' ); ?>
				...
				<button
					...
					aria-label="<?php esc_attr_e( 'Close favorites', 'shelterkit-pets' ); ?>"
				>
			...
			<div class="pet-favorites-modal__content">
				...
				>
					...
					<p><?php esc_html_e( 'No favorites yet.', 'shelterkit-pets' ); ?></p>
					<p class="pet-favorites-modal__empty-hint"><?php esc_html_e( 'Tap the heart on any pet to save them here.', 'shelterkit-pets' ); ?></p>
					<a
					...
					>
						<?php esc_html_e( 'Browse Adoptable Pets', 'shelterkit-pets' ); ?>
					</a>
				</div>
						...
						<article class="pet-favorites-modal__card" data-pet-id="<?php echo esc_attr( $pet['id'] ); ?>">
							...
							<div class="pet-favorites-modal__card-content">
									...
									<?php if ( ! empty( $pet['is_bonded_pair'] ) && ! empty( $partners ) ) : ?>
										<span class="pet-favorites-modal__badge-popover-anchor">
											...
											<div class="pet-favorites-modal__bonded-popover" hidden role="tooltip">
												...
												<p class="pet-favorites-modal__bonded-popover-label"><?php esc_html_e( 'Must adopt together with:', 'shelterkit-pets' ); ?></p>
								...
								<div class="pet-favorites-modal__card-actions">
									<button type="button" class="pet-favorites-modal__card-unfavorite js-unfavorite" data-pet-id="<?php echo esc_attr( $pet['id'] ); ?>" data-pet-name="<?php echo esc_attr( $pet['name'] ); ?>" aria-label="<?php echo esc_attr( sprintf( /* translators: %s: pet name */ __( 'Remove %s from favorites', 'shelterkit-pets' ), $pet['name'] ) ); ?>">
			...
			>
				<button
					...
					data-default-text="<?php esc_attr_e( 'Clear all favorites', 'shelterkit-pets' ); ?>"
					data-confirm-text="<?php esc_attr_e( 'Tap again to confirm', 'shelterkit-pets' ); ?>"
				>
					<?php esc_html_e( 'Clear all favorites', 'shelterkit-pets' ); ?>
				</button>
			</div>
		</div>
	</div>
